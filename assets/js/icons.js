/* =========================================================
   Telium PABX — Biblioteca de ícones (SVG inline, traço 24x24)
   ========================================================= */
const ICONS = {
  logo:      '<path d="M4 5h6l2 5-3 2a12 12 0 0 0 5 5l2-3 5 2v6a1 1 0 0 1-1 1A18 18 0 0 1 3 6a1 1 0 0 1 1-1z"/><path d="M15 3a6 6 0 0 1 6 6"/>',
  gauge:     '<path d="M12 21a9 9 0 1 1 9-9"/><path d="M21 12a9 9 0 0 1-1.5 5"/><path d="M12 12l4.5-3.5"/><circle cx="12" cy="12" r="1.6"/>',
  ...
  phoneIn:   '<polyline points="16 2 16 8 22 8"/><line x1="22" y1="2" x2="16" y2="8"/><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 1.9.7 2.8a2 2 0 0 1-.5 2.1L8.1 9.9a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.8.6 2.8.7a2 2 0 0 1 1.7 2z"/>',
  phoneOff:  '<line x1="23" y1="1" x2="17" y2="7"/><line x1="17" y1="1" x2="23" y2="7"/><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 1.9.7 2.8a2 2 0 0 1-.5 2.1L8.1 9.9a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.8.6 2.8.7a2 2 0 0 1 1.7 2z"/>',
  ...
  mic:       '<rect x="9" y="1" width="6" height="12" rx="3"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/>',
  voicemail: '<circle cx="6" cy="12" r="4"/><circle cx="18" cy="12" r="4"/><line x1="6" y1="16" x2="18" y2="16"/>',
  speaker:   '<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',
  ...
  checkCirc: '<path d="M22 11.1V12a10 10 0 1 1-5.9-9.1"/><polyline points="22 4 12 14 9 11"/>',
  ...
  eyeOff:    '<path d="M17.9 17.9A10.6 10.6 0 0 1 12 19c-7 0-11-7-11-7a19.6 19.6 0 0 1 5.1-5.9m3.4-1.7A10.6 10.6 0 0 1 12 5c7 0 11 7 11 7a19.7 19.7 0 0 1-2.2 3.2"/><path d="M9.9 4.2 20 20"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/>',
  ...
  hardDrive: '<line x1="22" y1="12" x2="2" y2="12"/><path d="M5.5 5h13a2 2 0 0 1 1.8 1.1l1.7 3.5V18a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9.6l1.7-3.5A2 2 0 0 1 5.5 5z"/><line x1="6" y1="16" x2="6.01" y2="16"/><line x1="10" y1="16" x2="10.01" y2="16"/>',
  wifi:      '<path d="M5 12.5a10 10 0 0 1 14 0"/><path d="M1.5 9a15 15 0 0 1 21 0"/><path d="M8.5 16a5 5 0 0 1 7 0"/><line x1="12" y1="20" x2="12.01" y2="20"/>',
  book:      '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>',
  branch:    '<line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/>',
  target:    '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1.5"/>',
  building:  '<rect x="4" y="2" width="16" height="20" rx="2"/><line x1="9" y1="7" x2="9.01" y2="7"/><line x1="15" y1="7" x2="15.01" y2="7"/><line x1="9" y1="12" x2="9.01" y2="12"/><line x1="15" y1="12" x2="15.01" y2="12"/><line x1="10" y1="22" x2="10" y2="17"/><line x1="14" y1="22" x2="14" y2="17"/>',
  creditCard:'<rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/>',
  helpCircle:'<circle cx="12" cy="12" r="9"/><path d="M9.1 9a3 3 0 0 1 5.8 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
  ...
  volume:    '<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.1 5a10 10 0 0 1 0 14"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/>'
};

/* Marca Telium — versão vetorial (nítida em qualquer tamanho) */
const TELIUM_MARK = `<svg viewBox="0 0 32 32" aria-hidden="true">
  <defs><linearGradient id="tlmG" x1="0" y1="0" x2="1" y2="1">
    <stop offset="0" stop-color="#2958a5"/><stop offset="1" stop-color="#1997cd"/></linearGradient></defs>
  <circle cx="16" cy="16" r="15" fill="url(#tlmG)"/>
  <path d="M4.2 18.4C7.6 11.4 14.4 6.8 22 6.8c2.5 0 4.9.5 7 1.4-2.3-.5-4.8-.4-7.2.3C15.9 10.2 11 14.7 8.8 20.4c-1.8 0-3.4-.6-4.6-2z" fill="#fff"/>
  <path d="M12.2 24.6c1.7-4.6 5.5-8.2 10.2-9.6 1.9-.6 3.8-.7 5.6-.4-1.5.6-3 1.5-4.3 2.6-3 2.5-5 5.9-5.9 9.6-2-.3-4-1.1-5.6-2.2z" fill="#fff" opacity=".8"/>
</svg>`;
